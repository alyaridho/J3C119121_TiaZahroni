...
public class CreateData extends AppCompatActivity {
    ...
    public void submitKlik(View v) {
        ...
        //inisialisasi barang baru (masih kosong)
                // yg com.example.pertemuan6kamis.Barang samain sama nama folder class ini dibuat!
                com.example.j3c119121_tiazahroni.Barang barang = null;
        ...
        switch(v.getId())
        {
            case R.id.buttom_submit:
                ...
                Toast.makeText(this, "Data Barang Masuk: \n" +
